...
client.connect();
var query = client.query('CREATE TABLE order_detailsdrp(id SERIAL PRIMARY KEY, order_id INT REFERENCES orders(id), vitamin_id INT REFERENCES vitamins(id), dose REAL, times_per_day INT)');
